...
const Form = ({ handleSubmit, handleChange, formData, errors }: FormProps) => (
    <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <div>
        <button style={{ backgroundColor: '#860000', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: 'pointer', fontWeight: 'bold', textTransform: 'uppercase'}} type="submit">
            Submit
        </button>
        </div>
    </form>
